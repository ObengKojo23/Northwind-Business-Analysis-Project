...
3. Launch SSMS application and follow along to achieve similar outcome. You can also access the `problem statement` file and all the `SQL queries` I used for this project from the `problem_statement_&_sql`.
